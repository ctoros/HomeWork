...
<script>
     function orrarTarea($idTarea) {
            ...
            console.log(body);
             debugger;
             $.post("service/orraTarea.php", body, function (a, b, c) {
                debugger;
                swal(
                        'Tarea borrada!',
