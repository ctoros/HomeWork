...
<body id="page-top">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index2.html">
        ...
        <div class="sidebar-brand-text mx-3">HomeWork</div>
      </a>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div class="my-2"></div>
            <button type="button" id="myBtn" data-toggle="modal" data-target="#myModal" class="btn btn-success btn-icon-split">
              ...
              <div class="modal-dialog"> -->
                ...
                <!-- <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <label>Nombre :</label>
                    <div><input type="text" name="nombre" value="Nombre Tarea"></div><br>
                    <label>Descripción :</label>
                    <div><textarea rows="4" cols="50"></textarea></div><br>
                  </div>
              ...
              <div class="col-lg-4">
                  ...
                  <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                      <h6 class="m-0 font-weight-bold text-primary">Limpiar el Baño</h6>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; HomeWork 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
...
<script>
     function orrarTarea($idTarea) {
            var body = {
                'titulo': $idTarea            } 
            console.log(body);
             $.post("service/orrarTarea.php", body, function (a, b, c) {
                debugger;
                swal(
                        'Tarea borrada!',
  ...
  $(document).ready(function(){
    ...
    $(document).ready(function () {
            ...
            $a = $.get("service/listWorks.php", body, function (a, b, c) {
             ...
             var imprimir= "";
            for (i in $listado) {
              imprimir +=  '<div class="col-lg-4"><!-- Dropdown Card Example --><div class="card shadow mb-4"><!-- Card Header - Dropdown -->                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between"><h6 class="m-0 font-weight-bold text-primary" id="'+$listado[i].id+'" >'+ $listado[i].titulo+ '</h6><div class="dropdown no-arrow"><a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i></a><div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink"><div class="dropdown-header">Acciones:</div><a class="dropdown-item" href="#">Completada</a><a class="dropdown-item" href="#">Asignar</a><div class="dropdown-divider"></div><a class="dropdown-item" onclick="orrarTarea('+$listado[i].id+')" href="#">Borrar</a></div></div></div><!-- Card Body --><div class="card-body">'+$listado[i].descripcion+'</div></div></div>';
